...
/****** Object:  StoredProcedure [Arquivo].[SAISP009_CSV_285]    Script Date: 14/09/2017 13:04:02 ******/
SET ANSI_NULLS ON
GO
...
/*
 ...
 Descricao :			pkgMOVIMENTOS_Producao_SEGMENTACAO_TIPO_REGISTRO_RENEGOCIACAO
 Arquivo (veracruz) :	MOVIMENTOS_RENEGOCIACAO_AAAMMDD.7z
...
ALTER PROCEDURE [Arquivo].[SAISP009_CSV_285]
AS
BEGIN
