...
/****** Object:  StoredProcedure [Arquivo].[SAISP010_CSV_286]    Script Date: 14/09/2017 13:04:12 ******/
SET ANSI_NULLS ON
GO
...
/*
 ...
 Descricao :			pkgMOVIMENTOS_Producao_SEGMENTACAO_TIPO_REGISTRO_AMORTIZACAO
 Arquivo (veracruz) :	MOVIMENTOS_AMORTIZACAO_AAAMMDD.7z
...
ALTER PROCEDURE [Arquivo].[SAISP010_CSV_286]
AS
BEGIN
